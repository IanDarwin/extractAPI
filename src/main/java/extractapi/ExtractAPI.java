...
/** Make up a compilable version of a given public API, 
 * so developers can compile against it without a licensed copy.
 ...
 */
public class ExtractAPI extends APIFormatter {

	public static void main(String[] argv) throws Exception {
		new ExtractAPI().doArgs(argv);
	}
	...
	public void doClass(Class<?> c) throws Exception {
		...
		// DO NOT try to use try-with-resources due to println in catch.
		PrintWriter out = new PrintWriter(new FileWriter(fileName));
		try {
			out.println("// Generated by ExtractAPI for class " + className);
			doClass(c, out, false);
		} catch (Exception t) {
			out.println("} // end of generated class");
			throw t;
		}
		finally {
			if (out != null)
